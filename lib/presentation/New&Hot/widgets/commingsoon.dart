    ...
    height: 400,child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text("LAST KINGDOM",style:GoogleFonts.artifika(textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.w500, letterSpacing: -1)),),
              Spacer(),
              Row(children: [
                CustomButton(icon: CupertinoIcons.bell, title:"Remind me",fontsize: 15,size: 20,),
                sizedBoxW10,
                CustomButton(icon: CupertinoIcons.info, title: "Info",fontsize: 15,size: 20,),
                sizedBoxW10
              ],),
            ],
          ),
